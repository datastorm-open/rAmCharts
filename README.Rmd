...
We have temporarily removed the 'am' functions.
Please refer to the branch **amFunctions** if you want to use one of these features during their development.
Once they are all ready, we will merge them to the master.
