...
We have temporarily move the 'am' functions to the dev directory.
Please refer to the branch **amFunctions** if you want to use one of these features during their development. We are improving the source code - they will be added to the R directory one by one as soon they are enough stable.
Once they are all ready, we merge them to the master.
